...
public final class Perlin {
    private static final int[] GRADIENTS = new int[SimplexNoiseGenerator.GRADS.length * 3];

    static {
        for (int i = 0; i < SimplexNoiseGenerator.GRADS.length; i++) {
            int[] grad = SimplexNoiseGenerator.GRADS[i];
