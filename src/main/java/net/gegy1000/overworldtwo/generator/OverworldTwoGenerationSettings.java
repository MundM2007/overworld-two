...
public class OverworldTwoGenerationSettings {
	public static final Codec<OverworldTwoGenerationSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			DimensionSettings.field_236097_a_.fieldOf("type").forGetter(settings -> settings.wrapped),
	...
	public final DimensionSettings wrapped;
	...
	public OverworldTwoGenerationSettings(DimensionSettings wrapped, double surfaceLacunarity, double surfacePersistence, double tearLacunarity, double tearPersistence, double extraDensityScale, double extraDensityLacunarity, double extraDensityPersistence) {
